      ...
      <main>
        ...
        <div className="bg-white place-items-center grid min-h-screen">
          ...
          <div className="w-full max-w-[1000px] mx-auto flex flex-wrap justify-center gap-4 text-center">
            ...
            <TopicTable title="Simplicidade e Usabilidade" descriple="Criamos sistemas intuitivos e práticos para garantir que nossos clientes possam aproveitar a tecnologia sem complicações." />
