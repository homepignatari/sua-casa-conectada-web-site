        ...
        <div className="navbar bg-white px-8">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm text-base dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow bg-blue-950 text-white">
                        <li><a>Home</a></li>
                        <li><a>Soluções</a></li>
                        <li><a>Serviços</a></li>
                        <li><a>Contato</a></li>
                ...
                <Image src={logo} alt='Logo azul sua casa conectada' />
            </div>
