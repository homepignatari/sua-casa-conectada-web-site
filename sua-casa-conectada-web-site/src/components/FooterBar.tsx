...
import logo from '../../public/logo maior 680x550.svg'

const FooterBar = () => {
  return (
      <div className='flex flex-col place-items-center gap-3 p-5'>
    ...
    <Image src={logo} alt='' />
      <p className='text-gray-300 font-mono'>Copyright © 2025 Sua Casa Conectada Todos os direitos reservados.</p>
    </div>
  )
}
